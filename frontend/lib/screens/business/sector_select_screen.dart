...
class SectorSelectScreen extends StatelessWidget {
  ...
  static const _sectors = [
    _SectorInfo(
      BusinessSector.tourism,
      '🏖️',
      'Tourism',
      'Beach shacks, hotels, tour operators',
    ),
    _SectorInfo(
      BusinessSector.cashew,
      '🌰',
      'Cashew',
      'Processing, roasting, export',
    ),
    _SectorInfo(
      BusinessSector.farmer,
      '🌾',
      'Farmer',
      'Paddy, horticulture, spices',
    ),
    _SectorInfo(
      BusinessSector.bakery,
      '🍞',
      'Bakery',
      'Pão de Goa, confectionery',
    ),
                        ...
                        .map(
                          (s) => _SectorCard(
                            ...
                            onTap: () => Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (_) => BusinessShell(sector: s.sector),
                              ),
                            ),
                          ),
                        )
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Center(
                child: Text(sector.emoji, style: const TextStyle(fontSize: 28)),
              ),
            ),
