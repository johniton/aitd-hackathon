              ...
              GlassCard(
                child: Column(
                  children: [
                        ...
                        children: [
                          SizedBox(
                            ...
                            child: CircularProgressIndicator(
                              value: (c.dailyTotal / 40).clamp(0.0, 1.0),
                              strokeWidth: 12,
                          ...
                          Column(
                            ...
                            children: [
                              Text(
                                '${c.dailyTotal.toStringAsFixed(1)} kg',
                                style: const TextStyle(
                                  color: AppTheme.textPrimary,
                                  fontSize: 20,
                    ...
                    Text(
                      'Daily emissions: ${c.dailyTotal.toStringAsFixed(1)} kg CO₂',
                      style: const TextStyle(
                        color: AppTheme.textPrimary,
                        fontSize: 14,
                        fontWeight: FontWeight.w700,
                    ...
                    const SizedBox(height: 4),
                    Text(
                      '${down ? "↓" : "↑"} ${c.weeklyDeltaPercent.abs().toStringAsFixed(0)}% from last week',
                      style: TextStyle(
                        color: down ? AppTheme.emerald : AppTheme.warning,
                        fontSize: 12,
                      ),
                    ),
                  ],
                ...
                GlassCard(
                  child: Row(
                    ...
                    children: [
                      _actionIcon(
                        Icons.eco,
                        plan.savings.carbonReduction,
                        'CO₂ Cut',
                      ),
                      _actionIcon(
                        Icons.currency_rupee,
                        plan.savings.moneySaved,
                        'Saved',
                      ),
                      _actionIcon(
                        Icons.lightbulb,
                        '${plan.optimizedPlanSteps.length} Steps',
                        'Plan',
                      ),
                      _actionIcon(
                        Icons.local_offer,
                        plan.subsidy.name.isNotEmpty
                            ? plan.subsidy.name
                            : 'Subsidy',
                        'Subsidy',
                      ),
                ...
                GlassCard(
                  child: Row(
                    children: [
                      ...
                      const Text(
                        'AI is analyzing your sustainability...',
                        style: TextStyle(
                          color: AppTheme.textSecondary,
                          fontSize: 13,
                        ),
                ...
                GlassCard(
                  child: Theme(
                    ...
                    child: ExpansionTile(
                      ...
                      subtitle: Text(
                        '${plan.optimizedPlanSteps.length} eco-steps • ${plan.optimized['carbon'] ?? ''}',
                        style: const TextStyle(
                          color: AppTheme.emerald,
                          fontSize: 12,
                        ),
                      ...
                      children: plan.optimizedPlanSteps
                          .map<Widget>(
                            (step) => ListTile(
                              dense: true,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (plan.source != 'fallback') ...[
                        const SizedBox(height: 4),
                        Text(
                          'Source: ${plan.source.toUpperCase()} AI',
                          style: TextStyle(
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor: AppTheme.lime.withValues(
                              alpha: 0.2,
                            ),
                          ...
                          onPressed: () =>
                              _showApplyDialog(context, plan.subsidy.name, c),
                        ),
                      ),
                    ],
                  ),
                ...
                GlassCard(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 4),
                      const Text(
                        'What your savings mean in real Goa terms',
                        style: TextStyle(
                          color: AppTheme.textSecondary,
                          fontSize: 11,
                        ),
                    ...
                    SizedBox(
                      ...
                      child: BarChart(
                        BarChartData(
                          ...
                          barGroups: [
                            for (int i = 0; i < c.weeklyTotals.length; i++)
                              BarChartGroupData(
                                x: i,
                                barRods: [
                                  BarChartRodData(
                                    toY: c.weeklyTotals[i],
                                    width: 14,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Slider(
                      min: 0,
                      max: 70,
                      value: c.simulationPercent,
                      activeColor: AppTheme.lime,
                      onChanged: c.updateSimulation,
                    ),
                    Text(
                      'Carbon saved: ${c.simulatedCarbonSaved.toStringAsFixed(1)} kg',
                      style: const TextStyle(
                        color: AppTheme.textPrimary,
                        fontSize: 12,
                      ),
                    ...
                    Text(
                      'Money saved: Rs ${c.simulatedMoneySaved.toStringAsFixed(0)}',
                      style: const TextStyle(
                        color: AppTheme.textPrimary,
                        fontSize: 12,
                      ),
                    ...
                    Text(
                      'Eco score: ${(c.ecoScore + c.simulationPercent * 0.2).toStringAsFixed(0)}',
                      style: const TextStyle(
                        color: AppTheme.emerald,
                        fontSize: 12,
                        fontWeight: FontWeight.w600,
              ...
              Row(
                children: [
                  Expanded(
                    child: StatTile(
                      label: 'Eco Score',
                      value: c.ecoScore.toStringAsFixed(0),
                      unit: '/100',
                      icon: Icons.star,
                    ),
                  ),
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: const [
                  Text(
                    'Guest transport mode',
                    style: TextStyle(
                      color: AppTheme.textSecondary,
                      fontSize: 12,
                    ),
                  ),
                  ScopeBadge(scope: EmissionScope.scope3),
                ],
              ),
              DropdownButtonFormField<TransportMode>(
                ...
                items: TransportMode.values
                    ...
                    .toList(),
                onChanged: (v) {
                  setState(() => _mode = v ?? TransportMode.car);
                  c.onInputChanged(mode: _mode);
                },
              ),
              const SizedBox(height: 8),
              _slider('Distance (km)', _distance, 1, 30, (v) {
                setState(() => _distance = v);
                c.onInputChanged(distance: v);
              }, scope: EmissionScope.scope3),
              _slider('Electricity kWh', _electricity, 0, 100, (v) {
                setState(() => _electricity = v);
                c.onInputChanged(electricity: v);
              }, scope: EmissionScope.scope2),
              _slider('LPG kg', _lpg, 0, 20, (v) {
                setState(() => _lpg = v);
                c.onInputChanged(lpg: v);
              }, scope: EmissionScope.scope1),
              _slider('Organic waste kg', _organicWaste, 0, 30, (v) {
                setState(() => _organicWaste = v);
                c.onInputChanged(organic: v);
              }, scope: EmissionScope.scope1),
              _slider('Oil waste kg', _oilWaste, 0, 15, (v) {
                setState(() => _oilWaste = v);
                c.onInputChanged(oil: v);
              }, scope: EmissionScope.scope1),
            ],
          ),
        ),
            ...
            children: [
              Expanded(
                child: ElevatedButton(
                  onPressed: () =>
                      c.startTrip(mode: _mode, mockDistanceKm: _distance),
        ...
        children: [
          ...
          Row(
            children: const [
              ...
              ScopeBadge(scope: EmissionScope.scope1),
            ],
          ),
          DropdownButtonFormField<String>(
            value: _fuelType,
            dropdownColor: AppTheme.surface,
            items: ['firewood', 'biomass', 'electric', 'LPG']
                .map(
                  (f) =>
                ...
                .toList(),
            onChanged: (v) {
              setState(() => _fuelType = v ?? 'firewood');
              c.onInputChanged(fuel: _fuelType);
            },
          ),
          const SizedBox(height: 8),
          _slider('Roasting hours/day', _roastingHours, 1, 16, (v) {
            setState(() => _roastingHours = v);
            c.onInputChanged(roasting: v);
          }, scope: EmissionScope.scope1),
          _slider('Shell waste kg/day', _shellWaste, 0, 50, (v) {
            setState(() => _shellWaste = v);
            c.onInputChanged(shellWaste: v);
          }, scope: EmissionScope.scope1),
          _slider('CNSL oil litres/day', _cnslOil, 0, 15, (v) {
            setState(() => _cnslOil = v);
            c.onInputChanged(cnsl: v);
          }, scope: EmissionScope.scope1),
          _slider('Electricity kWh', _electricity, 0, 200, (v) {
            setState(() => _electricity = v);
            c.onInputChanged(electricity: v);
          }, scope: EmissionScope.scope2),
          _slider('LPG kg', _lpg, 0, 30, (v) {
            setState(() => _lpg = v);
            c.onInputChanged(lpg: v);
          }, scope: EmissionScope.scope1),
        ],
      ...
      child: Column(
        ...
        children: [
          ...
          DropdownButtonFormField<String>(
            ...
            items:
                ['paddy', 'coconut', 'cashew', 'spices', 'vegetables', 'fruits']
                    .map(
                      (c) => DropdownMenuItem(
                        value: c,
                    ...
                    .toList(),
            onChanged: (v) {
              setState(() => _cropType = v ?? 'paddy');
              c.onInputChanged(crop: _cropType);
            },
          ),
          const SizedBox(height: 8),
          Row(
            children: const [
              ...
              ScopeBadge(scope: EmissionScope.scope1),
              ScopeBadge(scope: EmissionScope.scope2),
            ],
          ),
          DropdownButtonFormField<String>(
            value: _irrigationType,
            dropdownColor: AppTheme.surface,
            items: ['flood', 'drip', 'sprinkler', 'rainfed']
                .map(
                  (i) =>
                ...
                .toList(),
            onChanged: (v) {
              setState(() => _irrigationType = v ?? 'flood');
              c.onInputChanged(irrigation: _irrigationType);
            },
          ),
          const SizedBox(height: 8),
          _slider('Land (acres)', _landAcres, 0.5, 20, (v) {
            setState(() => _landAcres = v);
            c.onInputChanged(land: v);
          }),
          _slider(
            'Chemical fertilizer kg/day',
            _fertilizer,
            0,
            50,
            (v) {
              setState(() => _fertilizer = v);
              c.onInputChanged(fertilizer: v);
            },
            scope: EmissionScope.scope1,
          ),
          _slider('Pesticide litres/day', _pesticide, 0, 10, (v) {
            setState(() => _pesticide = v);
            c.onInputChanged(pesticide: v);
          }, scope: EmissionScope.scope1),
          _slider('Water usage litres/day', _waterUsage, 0, 2000, (v) {
            setState(() => _waterUsage = v);
            c.onInputChanged(water: v);
          }, scope: EmissionScope.scope2),
          _slider('Electricity kWh (pump)', _electricity, 0, 100, (v) {
            setState(() => _electricity = v);
            c.onInputChanged(electricity: v);
          }, scope: EmissionScope.scope2),
        ],
        ...
        children: [
          ...
          DropdownButtonFormField<String>(
            ...
            items: ['electric', 'gas', 'wood-fired']
                ...
                .toList(),
            onChanged: (v) {
              setState(() => _ovenFuel = v ?? 'electric');
              c.onInputChanged(ovenFuelType: _ovenFuel);
            },
          ),
          const SizedBox(height: 8),
          _slider('Oven hours/day', _ovenHours, 1, 16, (v) {
            setState(() => _ovenHours = v);
            c.onInputChanged(oven: v);
          }, scope: EmissionScope.scope1),
          _slider('Flour kg/day', _flourKg, 5, 100, (v) {
            setState(() => _flourKg = v);
            c.onInputChanged(flour: v);
          }, scope: EmissionScope.scope3),
          _slider('Butter/fat kg/day', _butterKg, 0, 20, (v) {
            setState(() => _butterKg = v);
            c.onInputChanged(butter: v);
          }, scope: EmissionScope.scope3),
          _slider('Bread waste kg/day', _breadWaste, 0, 15, (v) {
            setState(() => _breadWaste = v);
            c.onInputChanged(breadWaste: v);
          }, scope: EmissionScope.scope1),
          _slider('Electricity kWh', _electricity, 0, 150, (v) {
            setState(() => _electricity = v);
            c.onInputChanged(electricity: v);
          }, scope: EmissionScope.scope2),
        ],
        ...
        children: [
          ...
          DropdownButtonFormField<String>(
            ...
            items: ['grid', 'solar', 'diesel']
                ...
                .toList(),
            onChanged: (v) {
              setState(() => _otherEnergy = v ?? 'grid');
              c.onInputChanged(otherEnergy: _otherEnergy);
            },
          ),
          const SizedBox(height: 8),
          Row(
          ...
          DropdownButtonFormField<String>(
            value: _otherWaste,
            dropdownColor: AppTheme.surface,
            items: ['mixed', 'organic', 'plastic', 'electronic', 'chemical']
                .map(
                  (f) =>
                      DropdownMenuItem(value: f, child: Text(f.toUpperCase())),
                )
                .toList(),
            onChanged: (v) {
              setState(() => _otherWaste = v ?? 'mixed');
              c.onInputChanged(otherWaste: _otherWaste);
            },
          ),
          const SizedBox(height: 8),
          _slider('Electricity kWh/day', _electricity, 0, 500, (v) {
            setState(() => _electricity = v);
            c.onInputChanged(electricity: v);
          }, scope: EmissionScope.scope2),
          _slider('Water usage litres/day', _otherWater, 0, 5000, (v) {
            setState(() => _otherWater = v);
            c.onInputChanged(otherWater: v);
          }, scope: EmissionScope.scope2),
          _slider('Organic waste kg/day', _organicWaste, 0, 100, (v) {
            setState(() => _organicWaste = v);
            c.onInputChanged(organic: v);
          }, scope: EmissionScope.scope1),
          _slider('Other waste kg/day', _oilWaste, 0, 100, (v) {
            setState(() => _oilWaste = v);
            c.onInputChanged(oil: v);
          }, scope: EmissionScope.scope1),
        ],
        ...
        child: SafeArea(
          child: ListView(
            ...
            children: [
              ...
              const SizedBox(height: 6),
              const Text(
                'We need these details to generate a custom AI sustainability analysis, carbon credit assessment, and subsidy matches for your specific business.',
                style: TextStyle(
                  color: AppTheme.textSecondary,
                  fontSize: 13,
                  height: 1.4,
              ...
              GlassCard(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 4),
                    const Text(
                      'E.g. Retail Shop, Clinic, Tech Startup, Restaurant, Printing Press',
                      style: TextStyle(
                        color: AppTheme.textSecondary,
                        fontSize: 11,
                      ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      dropdownColor: AppTheme.surface,
                      decoration: const InputDecoration(
                        labelText: 'Primary Energy Source',
                      ),
                      items: ['grid', 'solar', 'diesel']
                          .map(
                            (f) => DropdownMenuItem(
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  onPressed: _otherBusiness.trim().isEmpty
                      ? null
                      : () {
                          ...
                          bool isBlocked = blockedBusinessTypes.any(
                            (b) => lower.contains(b),
                          );
                          ...
                          if (isBlocked) {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                content: Text(
                                  "Carbon credit analysis is not available for this business type.",
                                ),
                          ...
                          c.onInputChanged(
                            otherBusiness: _otherBusiness,
                            otherEnergy: _otherEnergy,
                            otherWaste: _otherWaste,
                            otherWater: _otherWater,
                            electricity: _electricity,
                            organic: _organicWaste,
                            oil: _oilWaste,
                          );
              ...
              if (_otherBusiness.trim().isEmpty) ...[
                const SizedBox(height: 8),
                const Text(
                  'Please enter your business type to continue',
            ...
            child: Column(
              ...
              children: [
                ...
                const DisclaimerBanner(
                  disclaimerKey: 'subsidy_apply_disclaimer',
                ),
                const SizedBox(height: 8),
                Text(
                  'Basic Eligibility',
